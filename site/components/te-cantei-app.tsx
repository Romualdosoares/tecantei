...
const occasionsConfig = [
  ...
  { label: "Conquistar um Crush", icon: Sparkles },
  { label: "Amigo(a)", icon: Users },
  { label: "Aniversário", icon: Gift },
...
export default function TeCanteiApp({ initialStep = 0, initialAccountOpen = false }: { initialStep?: number; initialAccountOpen?: boolean }) {
  ...
  const goTo = (next: number) => {
    ...
    if (destination === 0 && initialStep > 0) {
